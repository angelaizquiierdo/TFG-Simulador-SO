// Punto de entrada del módulo — registra los algoritmos incluidos al importar
...
// Registrar todos los algoritmos incluidos en el módulo
register(new FCFS());
register(new SJF());
register(new LJF());
...
// Re-exportar la API pública del módulo
