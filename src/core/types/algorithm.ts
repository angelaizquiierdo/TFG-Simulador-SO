// Vista de solo lectura de un proceso en la cola de listos (usada por los algoritmos)
...
// Modo de expropriación del algoritmo
export type PreemptionMode = 'none' | 'on-better' | 'on-quantum';

// Contrato que debe cumplir cualquier algoritmo de planificación
